...
<form action="#" method="post">
	...
	<fieldset>
		...
		<div>
			...
			<c:out value="${personnel['cotisation']}" />
			<span class="euro"></span>
		</div>
		<div>
			<span class='text-label'>Droit à l'image : </span><c:choose>
							<c:when test="${personnel['droitImage']==true}">Oui</c:when>
		...
		<div>
			<span class='text-label'>Membre CA : </span><c:choose>
							<c:when test="${personnel['membreCA']==true}">Oui</c:when>
							<c:otherwise>Non</c:otherwise>
						</c:choose>
