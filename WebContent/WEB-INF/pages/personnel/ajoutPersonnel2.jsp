...
<form id="ajoutp2" method="post" action="<c:url value="<%=Pattern.PERSONNEL_AJOUT2%>" />">
	<fieldset>
		...
		<div>
			...
			<select name="type" id="type" onClick="afficherDuree()">
		...
		<div>
			<label for="datedebEns" class="required">Date de début d'enseignement : </label>
			<input type="text" name="datedebEns" class="datepicker" required/>
		</div>
	...
	<fieldset class='align-center no-border'>
		<a href="<c:url value="<%=Pattern.PERSONNEL_AJOUT%>" />">
		<input type="button" value="Retour" /></a> <input type="submit" value="Valider"/>
	</fieldset>
</form>
