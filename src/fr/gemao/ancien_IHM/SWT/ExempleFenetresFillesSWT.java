...
public class ExempleFenetresFillesSWT {
	// ========================================
		...
		public ChildShell(Display display) {
			...
			shell.addListener(SWT.Close, new Listener() {
				...
				public void handleEvent(Event event) {
					System.out
							.println("Child Shell handling Close event, about to dispose this Shell");
					shell.dispose();
				}
			});
		}
	...
	public ExempleFenetresFillesSWT() {
		// ======================================================
		...
		spawn.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				// =====================================================
				System.out
						.println("Main Shell handling Button press, about to create child Shell");
		...
		mainWindowShell.addListener(SWT.Close, new Listener() {
			...
			public void handleEvent(Event event) {
				System.out
						.println("Main Shell handling Close event, about to dipose the main Display");
				display.dispose();
			}
		});
