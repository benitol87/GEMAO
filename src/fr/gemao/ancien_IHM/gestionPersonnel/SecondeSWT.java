...
public class SecondeSWT {
	...
	/**
	 * M�thode d'ajout des �couteurs
	 */
	private void dispatchEvents(){
		button_annuler.addMouseListener(new MouseListener() {
			
			/**
			 * Red�finition de la m�thode de l'�couteur sur le bouton de la souris relach�
			 */
			@Override
			...
			/**
			 * Red�finition de la m�thode de l'�couteur sur le bouton de la souris enfonc�
			 */
			@Override
			...
			/**
			 * Red�finition de la m�thode de l'�couteur sur le double clic
			 */
			@Override
	...
	/**
	 * M�thode qui permet de mettre en pause le Launcher
	 */
	private void start() {
