...
public class APayeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (id == null) {
			...
			RecupererAdherentCtrl recupAdhCtrl = new RecupererAdherentCtrl();
			Adherent adherent = recupAdhCtrl.recupererAdherent(idAdh);
			...
			req.getRequestDispatcher(JSPFile.ADHERENT_A_PAYE)
					.forward(req, resp);
		}
	}
