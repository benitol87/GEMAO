	...
	protected void doGet(HttpServletRequest request,
		...
		if (request.getParameter("id") == null) {
			this.getServletContext()
					.getRequestDispatcher(JSPFile.PERSONNEL_LISTER)
			...
			List<Responsabilite> listeResponsabilite = personnel
					.getListeResponsabilite();
			...
			this.getServletContext()
					.getRequestDispatcher(JSPFile.PERSONNEL_MODIFIER)
					.forward(request, response);
		}
	}
